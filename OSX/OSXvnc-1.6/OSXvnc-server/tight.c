...
static Bool                                                                   
CheckSolidTile32(cl, x, y, w, h, colorPtr, needSameColor)                      
rfbClientPtr cl; 
int x, y;                                                                 
CARD32 *colorPtr;                                                         
Bool needSameColor;                                                       
{                                                                             
	...
	int dx, dy;                                                               
				...
				fbptr = (CARD32 *)                                                     
					&cl->scalingFrameBuffer[y * cl->scalingPaddedWidthInBytes + x * (32/8)]; 
				...
				for (dy = 0; dy < h; dy++) {                                              
					...
					fbptr = (CARD32 *)((CARD8 *)fbptr + cl->scalingPaddedWidthInBytes); 
				}                                                                         
    ...
    int x, y, w, h;
{
	...
	SHAREDAPP_TRACE("trace(%d): Rect %x", NMSG++, rfbEncodingTight);

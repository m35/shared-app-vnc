...
#define rfbProtocolMinorVersion 30  // GRW - SharedAppVnc is minor version 30
...
typedef struct _rfbSharedAppUpdateMsg {
	...
	CARD16 cursorOffsetX; /* added for Mac OSX which can return 0,0 origin image of window */

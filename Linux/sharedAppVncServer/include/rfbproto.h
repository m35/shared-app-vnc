...
#define rfbProtocolMinorVersion 30 
...
#define rfbSharedAppDisconnect 49
 ...
 *   0xFFFFFF31 .. 0xFFFFFFDF -- not allocated yet;
...
/*
 * Extension for SharedAppVnc -- SHAREDAPP
 * Each SharedAppUpdateMsg message will send the updates for that window only
 */

typedef struct _rfbSharedAppUpdateMsg {
  CARD8 type;              /* rfbSharedAppUpdate or rfbSharedAppLast */
  CARD8 pad;
  CARD16 nRects;
  CARD32 win_id;
...
/*-----------------------------------------------------------------------------
 * SharedAppRequest - SHAREDAPP client->server requests
 */

#define rfbSharedAppRequestNone        0x0
#define rfbSharedAppRequestEnable      0x1 /* enable this extension */
#define rfbSharedAppRequestDisable     0x2 /* disable winshare - show normal vnc desktop */
#define rfbSharedAppRequestOn          0x3 /* start showing shared windows */
#define rfbSharedAppRequestOff         0x4 /* show nothing */
#define rfbSharedAppRequestShow        0x5 /* add a window to show list */
#define rfbSharedAppRequestHide        0x6 /* remove a window from show list */
#define rfbSharedAppRequestHideAll     0x7
#define rfbSharedAppReverseConnection  0x8
#define rfbSharedAppRequestIncludeDialogs  0x9
#define rfbSharedAppRequestExcludeDialogs  0xa

typedef struct {
  CARD8 type;          /* always rfbSharedApp */
  CARD8 pad1;
  CARD16 command;      /* show or hide type */
  CARD32 id;           /* id of target window (application) - 0x0 for on/off command*/
} rfbSharedAppRequestMsg;

#define sz_rfbSharedAppRequestMsg 8


typedef struct {
  CARD8 type;          /* always rfbMultiCursor */
  CARD8 pad1;
  CARD16 cursorNumber;      /* cursor number to use */
} rfbMultiCursorMsg;

#define sz_rfbMultiCursorMsg 4
...
#define sz_rfbChromiumStartMsg 8
